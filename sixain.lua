...
local function CarregarSixAin()
    ...
    local SixAin = {
        Nome = "SixAin",
        Versao = "2.0",
        CorPrimaria = Color3.fromRGB(160, 80, 255),
        CorSecundaria = Color3.fromRGB(80, 40, 150),
    ...
    local function CriarInterface()
        ...
        Border.BackgroundColor3 = Color3.fromRGB(80, 40, 150)
        ...
        local function CriarBotao(nome, texto, cor, callback)
            local btn = Instance.new("TextButton")
            btn.Name = nome
            btn.Size = UDim2.new(0, 40, 0, 30)
            btn.Position = UDim2.new(1, -45, 0.5, -15)
            btn.BackgroundColor3 = cor or Color3.fromRGB(40, 40, 60)
        ...
        local MinimizarBtn = CriarBotao("Minimizar", "─", nil, function()
            MainFrame.Visible = not MainFrame.Visible
        end)
        MinimizarBtn.Position = UDim2.new(0.5, -45, 0.5, -15)
        
        local FecharBtn = CriarBotao("Fechar", "✕", Color3.fromRGB(177, 58, 75), function()
            ScreenGui:Destroy()
        end)
        ...
        local function CriarToggle(posX, texto, configVar)
            ...
            frame.Size = UDim2.new(0.45, 0, 1, 0)
        ...
        FOVFrame.Position = UDim2.new(0, 0, 0, 60)
        ...
        ESPFrame.Size = UDim2.new(1, 0, 0, 35)
        ESPFrame.Position = UDim2.new(0, 0, 0, 120)
        ESPFrame.BackgroundTransparency = 1
        ESPFrame.Parent = Content
        
        local ESPStatus = Instance.new("Frame")
        ESPStatus.Size = UDim2.new(0.6, 0, 1, 0)
        ESPStatus.Position = UDim2.new(0.2, 0, 0, 0)
